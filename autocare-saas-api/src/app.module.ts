...
@Module({
  imports: [
    ...
    PrismaModule, TimezoneModule, AuthModule, CustomersModule, VehiclesModule, BranchesModule, ServiceHistoryModule, AppointmentsModule, TenantSettingsModule, InvoicesModule,
  ],
})
